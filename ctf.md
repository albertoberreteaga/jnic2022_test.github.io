...
<a id="inicio"></a>
<a href="{{site.url}}/ctf"><img src="{{site.url}}/images/Icoflag.jpg" class="img-circle" 	width="40" height="40"><strong>Capture The flag</strong></a> &nbsp;&nbsp;&nbsp;
<a href="{{site.url}}/actividades-sociales"><img src="{{site.url}}/images/Icospeaker.jpg" class="img-circle" 	width="40" height="40"><strong>Call for Flags</strong></a>&nbsp;&nbsp;&nbsp;
</div><br>
